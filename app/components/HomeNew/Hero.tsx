        ...
        <div className='relative'>
            <div className="w-full 1000px:flex items-center bg-[#fafafa] 1000px:pt-10 ">
                ...
                <div className="pt-50 1000px:w-[60%]  justify-center md:justify-start flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left min-h-[70vh]">
                    ...
                    Ducky <p className='text-gradient'>Engineer</p>
                    </h2>
                    <br />
                    ...
                    <div className="flex gap-2 1500px:!w-[55%] 1100px:!w-[78%] flex-wrap">
                        <div onClick={() => setOpen(true)} data-aos="fade-up" data-aos-delay="500" className="box-shadow-grow flex items-center justify-center h-[40px] w-[150px] md:h-[60px] md:w-[200px] font-size-[12px]  md:font-size-[16px] text-[16px] font-bold leading-[56px] fill-[#FFFFFF] text-[#ffff] bg-[#26d07c] hover:bg-[#26d07c] hover:border-[#26d07c] cursor-pointer border-solid border-[2px_2px_2px_2px] border-[#26d07c] rounded-lg px-[20px] md:px-[50px] py-0">
                           <span>Join Us </span> 
                        </div>
                        <div onClick={() => {router.push('/courses')}} data-aos="fade-up" data-aos-delay="600" className="flex items-center justify-center  h-[40px] w-[150px]  ml-4 md:h-[60px] md:w-[200px] font-size-[12px]  md:font-size-[16px] text-[16px] font-medium leading-[56px] bg-[#FFFFFF] text-[#26d07c]  border-solid border-2 border-[#26d07c] box-shadow-grow hover:text-black cursor-pointer hover:border-[#26d07c]  rounded-lg text-center px-[20px] md:px-[40px]">
                            Find Courses
                        </div>
                    </div>
                    <br />
